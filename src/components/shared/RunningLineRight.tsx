...
const FirstTickerWrapper = styled(Box)`
  ...
  top: 0;
  right: 0;
  animation: tickerRightFirst 15s infinite linear forwards;

  @keyframes tickerRightFirst {
    0% {
...
const SecondFirstTickerWrapper = styled(FirstTickerWrapper)`
  animation: tickerRightSecond 15s infinite linear forwards;

  @keyframes tickerRightSecond {
    0% {
      transform: translate(-100%, 0);
    }
